...
#ifndef owl_script_list_H
#define owl_script_list_H
...
namespace type {
	...
	class OWL_SCRIPT list : public object
	{
		public:
						list		();
			virtual		~list		();
			...
			static void script_at		(owlsl::vm* vm);
			static void script_count	(owlsl::vm* vm);
			static void script_clear	(owlsl::vm* vm);
			static void script_borrame_print(owlsl::vm* vm);
	};

}}

#endif // owl_script_list_H